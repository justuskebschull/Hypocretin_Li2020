---
title: "Hcrt analysis - females only"
output: pdf_document
---

```{r opts, echo = FALSE}
knitr::opts_chunk$set(
  fig.path = "female_images_gr/"
)
```
...
hcrt$sex<-sex
Idents(hcrt)<-'sex'
hcrt<-subset(hcrt,idents='female')
...
#write.csv(markers.filtered,file='~/postdoc2/Shibin_hypocretin/hypocretin/females_cluster_DEGs.csv')
```
...
```{r}
#write.csv(agemarkers2[agemarkers2$p_val_adj<0.05,],file = '~/postdoc2/Shibin_hypocretin/hypocretin/agemarkers_female.csv')
```
